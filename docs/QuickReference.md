...
# Contenido
- [Componentes](#componentes-de-kubernetes)
...
- [Rolling updates](#actualización-continua-rolling-updates)
- [Objetos Kubernetes](#modelo-de-objetos-de-kubernetes)
- [Comandos básicos y ejercicios de laboratorio](Laboratorio.md)
- [Guia de autoescalado pra EKS](aws-autoscaler-eks.md) **(nuevo)**
...
Lsa actualizaciones contínuas permiten las siguientes acciones:
